...
<script type="application/ld+json">
{
  ...
  <body>
   ...
   <!-- <div class="cursor"></div>
    ...
    <div class="page__title-breadcrumb" style="display: flex; justify-content: center;">                            
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page" style="color: rgb(212, 0, 0);">About Us</li>
        </ol>
      </nav>
  </div>
    <!-- Breadcrumb End -->
    ...
    <section class="intro-sec about-us-sec-1">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex justify-content-center flex-column">
            <div class="about-info-1">
              <p class="p-1">ABOUT GEORGE ANIMATRIX</p>
              <h1>SCHOOL OF ANIMATION</h1>
              <p>
                <a href="https://www.georgeanimatrix.com"><strong>George Animatrix school of Animation</strong></a> is one the premier
                Institutes for education in <strong> <a href= "https://www.georgeanimatrix.com/animation-course-in-kolkata.php"> Animation</a> , <a href="https://www.georgeanimatrix.com/vfx-course-in-kolkata.php">VFX</a>, <a href="https://www.georgeanimatrix.com/web-graphics-design-course-in-kolkata.php">Web Graphic Design</a>, <a href="https://www.georgeanimatrix.com/photography-course-in-kolkata.php"> Photography Course</a> </strong>. The academy started its journey as an
                educational centre in 2013. Since its commencement, the
                animation institute in Kolkata has created talented people to
                meet the ever increasing requirements in the Animation industry.
                The Institute is armed with highly trained and certified
                professionals from the Industry to provide high-grade education
                to students.
              </p>
            </div>
          </div>
          <div class="col-lg-6 mb-20">
            <img class="img-fluid" src="./assets/img/h3.jpg" alt="About George Animatrix" />
          </div>
        </div>
        <div class="vision">
            <h5>Vision</h5>
            <p>To provide the best talent to the animation industry and establish India as a resource for global animation and VFX industry.</p>
            <h5>Mission</h5>
            <p>Our prime mission as the best animation school in Kolkata is to deliver education that can act as a foundation for a bright career.</p>
        </div>
      </div>
    </section>

    <section class="intro-sec about-us-sec-2">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <p class="p-1">The</p>
            <h1>TRAINING PROCESS</h1>
            <img class="img-fluid" src="./assets/img/h4.jpg" alt="George Animatrix Training Process" />
          </div>
          <div class="col-lg-6 d-flex justify-content-center flex-column">
            <div class="about-info-2">
              <p>
                Creating an animation character is a very tough job, a great
                deal of mastery is involved in every way while creating a
                complete animation character. To master the skill, inordinate
                effort and well-designed training program is required. At
                Animatrix school of Animation the students, under-go vibrant
                training sessions. The academy conducts training on advanced
                diploma in multimedia and animation, web design courses and dual
                certificate courses. George Animatrix aspirants learn through
                the internship process that allows them to gain an experience of
                a real-life production process. Students get the opportunity to
                explore their talent through such training sessions.<br/> The course
                content is updated from time to time in accordance with the
                national and international standard of the industry. In order to
                motivate students and augment the knowledge of real-life
                production need, the Institute always introduces experienced
    ...
    <section class="intro-sec about-us-sec-3">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex justify-content-center flex-column">
            <div class="about-info-3">
              ...
              <ul>
                <li>
                  Classes are held from Monday to Friday between 10.00 AM -
                  06.00 PM
                </li>
                <li>
                ...
                <li>
                  There is 30 minutes complimentary lunch break in between 2
                  segments.
                </li>
                <li>
                  There is 30 minutes complimentary lunch break in between 2
                ...
                <li>
                  Apart from regular classes there is industry meet sessions
                  organized. During these sessions the students have the chance
                  to meet with the industry professionals.
                </li>
                <li>
                  Experts from VFX-Graphics-Animation industry conducts
                  workshops.
                </li>
              </ul>
            </div>
          ...
          <div class="col-lg-6">
            <img class="img-fluid" src="./assets/img/h2.jpg" alt="George Animatrix  Training Schedule" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bottom-sec">
        <div class="container">
            <div class="bottom-sec-inner">
                <h1>THE ANIMATRIX CURRICULUM</h1>
                <p>
                The curriculum is the essence of any educational process, without a
                curriculum, it is hard to perceive any enlightening endeavour. In a
                genuine sense, it is a pathway towards a goal. George Animatrix, while
                keeping this concept in mind has designed its curriculum. It focuses
                mainly on the art, craft and business of storytelling.
                </p>
                <p>
                Students opting for any particular field, need to cover all the other
                aspects of digital filmmaking and digital arts. In order to improve
                the knowledge and skill, the aspirants need to go through both
                theoretical and practical knowledge sessions at each step. To
                facilitate students enjoy the real-life experience of production, the
                academy has got up-to-date projection system rooms, post-production
                labs, production space and animation labs.
                </p>
                <p>
                In addition to this, the institute is constantly upgrading its
                curriculum and career development program, to help students get
                prepared to face the challenging needs of the industry.
                </p>
            </div>
        </div>  
    </section>
