...
<html lang="en">
  <head>
    ...
    <title>Competition and Events by George Animatrix</title>
     <meta name="description" content="At the George Animatrix, besides course training and projects, students have the opportunities to participate in various events & competitions. For more visit the website now.">
  ...
  <body>
   ...
   <!--  <div class="cursor"></div>
                            ...
                            <ul>
                               ...
                               <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="#">Event & Competition</a></li>
                                     </ul>
                                </li>
                                <li>
    ...
    <div class="page__title-breadcrumb" style="display: flex; justify-content: center;" >                            
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-1">
          ...
          <li class="breadcrumb-item active" aria-current="page" style="color: rgb(212, 0, 0);">Events & Competition</li>
        </ol>
      </nav>
  </div>
    <!-- Breadcrumb End -->
    ...
    <main>
        ...
        <!-- teacher area start -->
        <section class="teacher__area pt-30 pb-15">
           <div class="container">
              <div class="row">
                 <div class="col-xxl-6 offset-xxl-3">
                    <div class="section__title-wrapper text-center mb-30">
                       <h2 class="section__title">Events &<span class="yellow-bg"> Competition<img src="assets/img/shape/yellow-bg-2.png" alt="">  </span>
                       </h2>
                    </div>
                 </div>
              </div>
              <div class="student-work__Photos pb-50">
                <p>Competition</p>
                <h1 class="student-work_photos_title">Diwali 2019</h1>
                <div class="row gy-3 gx-3">
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_2019_01.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_2019_02.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_competition_2019_01.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_competition_2019_02.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_competition_2019_03.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Diwali_competition_2019_04.jpg" alt="">
                   </div>
                </div>
              </div>

              <div class="student-work__Photos pb-50">
                <p>Arts, Events Awards</p>
                <h1 class="student-work_photos_title">Sarad Baran 2019</h1>
                <div class="row gy-3 gx-3">
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/01.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/02.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/03.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton//04.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/05.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/06.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton//07.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton//08.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton//09.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton//10.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/11.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/12.jpg" alt="">
                   </div>
                </div>
              </div>
              ...
              <div class="student-work__Photos pb-50">
                <p>Competition</p>
                <h1 class="student-work_photos_title">Dewali 2019</h1>
                <div class="row gy-3 gx-3">
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/15th_august_2019.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Holi_2019.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/events-&-competiton/Rath-yatra_2019.jpg" alt="">
                   </div>
                </div>
              </div>
