...
<head>
    ...
    <title>Get Certificate in Basic Photography Editing Courses In Kolkata</title>
    <meta name="description" content="George Animatrix introduce professional photography course in kolkata, Get chance to learn basic photography and editing coursewith an affordable prices.">
                  ...
                  <div class="course__wrapper">
                        ...
                        <div class="page__title-breadcrumb">                            
                            <nav aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page" style="color: rgb(212, 0, 0);">Photography Course</li>
                              </ol>
                            </nav>
                        </div>
                        <h1 class="page__title-3">Photography Course in Kolkata</h1>
                     </div>
                     <div class="course__img w-img mb-30">
                        <img src="./assets/img/course1/photography.jpg" alt="Photography Course">
                     </div>
                     <div class="course__tab-2 mb-45">
                        <ul class="nav nav-tabs" id="courseTab" role="tablist">
                           ...
                           <li class="nav-item" role="presentation">
                             <button class="nav-link " id="curriculum-tab" data-bs-toggle="tab" data-bs-target="#curriculum" type="button" role="tab" aria-controls="curriculum" aria-selected="false"> <i class="icon_book_alt"></i> <span>Practical</span> </button>
                           </li>
                           <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="courseTabContent">
                           <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                              <div class="course__description">
                                 ...
                                 <p style="text-align: justify;">George Animatrix is proud to introduce a new <strong>course in Basic Photography and Editing</strong>. This is a professional <strong>photography course</strong> modulated to help students understand all the basics in professional photography and post processing. Students will be given sufficient doubt clearing classes as well for better understanding of the concepts. The completion of the <strong>photography training course</strong> will be awarded with certification for all students. This basic training session will prepare you to become a professional. George Animatrix has been a leader institute encompassing talent in all field of multimedia. For years it has given wings to talented and skilled artists. If you seek to learn and become better at your craft then this is your opportunity. Contact us for admission or course detail enquiry.</p>
                    ...
                    <div id="captcha-error"></div>
                              ...
                              <div class="col-xxl-12">
                                 <div class="contact__btn">
                                    <button class="btn1 btn2"  type="submit" name="submit"  id="form-submit">Apply Now</button>
                                 </div>
                              </div>
                           </div>
                        </form>                    
                                ...
                                <div class="mb-3">
                                    <div class="course__description-list">
                                       <p>PHOTOGRAPHY COURSES</p>
                                       <h2>Certificate in Photography (video & Still) & Editing</h2>                                  
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="course__description-list">
                                       <p>PHOTOGRAPHY COURSES</p>
                                       <h2>Certificate in Image & Video Editing</h2>                                  
                                    </div>
                                    <div class="course-page-details">
                                       <h4>Eligibility:<span> 10+2/Equivalent</span></h4>
                                       <h4>Duration:<span> 6 Months</span></h4>
                                 ...
                                 <div class="row">
                                    <div class="col-xxl-6">                                       
                                       <div class="youtube-video">
                                          <a href="./assets/img/web-design.jpg" title="" itemprop="url"
                                    ...
                                    <div class="col-xxl-6">                                       
                                       <div class="youtube-video">
                                          <a href="./assets/img/graphics-deg.jpg" title="" itemprop="url"
                                            data-fancybox="gallery">
                                            <img src="./assets/img/graphics-deg.jpg" alt="" />
                                          </a>
                                       </div>
                                    </div>
                                    <div class="col-xxl-6">                                       
                                       <div class="youtube-video">
                                          <iframe src="https://www.youtube-nocookie.com/embed/46aq3AjQiro" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                       </div>
                                    </div>
                                    <div class="col-xxl-6">                                       
                                       <div class="youtube-video">
                                          <iframe src="https://www.youtube-nocookie.com/embed/YAuY_0DHq4E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="course__comment mb-75">                                
                                    <ul>
                                       <li>
                                          <div class="course__comment-box ">
                                             <div class="course__comment-thumb float-start">
                                                <img src="./assets/img/review/urmimala.png" alt="">
                                             </div>
                                             <div class="course__comment-content">
                                                <div class="course__comment-wrapper ml-70 fix">
                                                   <div class="course__comment-info float-start">
                                                      <h4>Urmimala Maity</h4>
                                                   </div>
                                       ...
                                       <li>
                                          <div class="course__comment-box ">
                                             <div class="course__comment-thumb float-start">
                                                <img src="./assets/img/review/ahana.png" alt="">
                                             </div>
                                             <div class="course__comment-content">
                                                <div class="course__comment-wrapper ml-70 fix">
                                                   <div class="course__comment-info float-start">
                                                      <h4>Ahana Chatterjee</h4>
                                                   </div>
                                                   <div class="course__comment-rating float-start float-sm-end">
                                                      <ul>
                                                         <li><a href="#"> <i class="icon_star"></i> </a></li>
                                       ...
                                       <li>
                                          <div class="course__comment-box ">
                                             <div class="course__comment-thumb float-start">
                                                <img src="./assets/img/review/sucharita.png" alt="">
                                             </div>
                                             <div class="course__comment-content">
                                                <div class="course__comment-wrapper ml-70 fix">
                                                   <div class="course__comment-info float-start">
                                                      <h4>Sucharita goswami</h4>
                                                   </div>
                                                   <div class="course__comment-rating float-start float-sm-end">
                                                      <ul>
                                                         <li><a href="#"> <i class="icon_star"></i> </a></li>
                                 ...
                                 <div class="swiper-wrapper">
                                    ...
                                    <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                       <div class="course__thumb w-img p-relative fix">
                                          <a href="vfx-course-in-kolkata.php">
                                             <img src="./assets/img/vfx-2.jpg" alt="">
                                          </a>
                                          <div class="course__tag">
                                             <a href="vfx-course-in-kolkata.php" class="sky-blue">VFX Course</a>
                                          </div>
                                       </div>
                                    ...
                                    <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                       <div class="course__thumb w-img p-relative fix">
                                          ...
                                          <div class="course__tag">
                                             <a href="web-graphics-design-course-in-kolkata.php" class="green">Graphic Design</a>
                                          </div>
                                       </div>
                                       <div class="course__more d-flex justify-content-between align-items-center">
                                          <div class="course__btn">
