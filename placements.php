...
<html lang="en">
  <head>
    ...
    <title>100% Placement Guarantee at George Animatrix</title>
     <meta name="description" content="Visit the pages and check the details of placements which is provides by George Animatrix, after completed their certification couses. Get to know more details call us today.">
...
<div class="modal fade" id="onload" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="page__title-breadcrumb" style="display: flex; justify-content: center;" >                            
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-1">
          ...
          <li class="breadcrumb-item active" aria-current="page" style="color: rgb(212, 0, 0);">Student Placement</li>
        </ol>
      </nav>
  </div>
    <!-- Breadcrumb End -->
    ...
    <main>
        ...
        <!-- teacher area start -->
        <section class="teacher__area pt-30 pb-25">
           <div class="container">
              <div class="row">
                 <div class="col-xxl-6 offset-xxl-3">
                    <div class="section__title-wrapper text-center mb-60">
                       <h1 class="section__title">Our <span class="yellow-bg">Students <img src="assets/img/shape/yellow-bg-2.png" alt="">  </span>Placement
                       </h1>
              ...
              <div class="row justify-content-center">
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Debamita_Dutta.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Debamita Dutta,</h3> 
                 ...
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Anubrata_Poddar.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Anubrata Poddar</h3> 
                          <span>Interior Desginer</span>
                       </div>
                    </div>
                 </div>
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Rishita_Chatterjee.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Rishita Chatterjee,</h3> 
                 ...
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Pritam_Debna.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Pritam Debna,</h3> 
                          <span>Compositing Artist</span>
                       </div>
                    </div>
                 </div>
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Somtirtha_saha.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Somtirtha Saha,</h3> 
                          <span>2D Animation & Editor</span>
                       </div>
                    </div>
                 </div>
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Shivnath_Dutt.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Shivnath Dutta,</h3> 
                 ...
                 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="teacher__item text-center transition-3 mb-30">
                       <div class="teacher__thumb w-img fix">
                          <a href="#">
                             <img src="./assets/img/plcement/Amit_Gomasta.jpg" alt="">
                          </a>
                       </div>
                       <div class="teacher__content">
                          <h3 class="teacher__title">Amit Gomasta,</h3> 
                          <span>Motion Graphics Artist</span>
                       </div>
                    </div>
                 </div>
