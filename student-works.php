...
<html lang="en">
  <head>
    ...
    <title>Check Our Student Works - George Animatrix</title>
    <meta name="description" content="George Animatrix showing here their student works. Visit the website and check the work details now. For more enquiry call us directly.">
    ...
    <div class="page__title-breadcrumb" style="display: flex; justify-content: center;" >                            
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-1">
          ...
          <li class="breadcrumb-item active" aria-current="page" style="color: rgb(212, 0, 0);">Students Work</li>
        </ol>
      </nav>
  </div>
    <!-- Breadcrumb End -->
              ...
              <div class="row">
                 <div class="col-xxl-6 offset-xxl-3">
                    <div class="section__title-wrapper text-center mb-30">
                       <h2 class="section__title">Our <span class="yellow-bg">Students <img src="assets/img/shape/yellow-bg-2.png" alt="">  </span>Work
                       </h2>
                       
                    </div>
                 </div>
              </div>
              <div class="student-work__Photos pb-50">
                <p>Student Work</p>
                <h1 class="student-work_photos_title">Photos</h1>
                <div class="row gy-3 gx-3">
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Amit_Gomasta_Delage_D8.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Amit_Gomasta_Scar-H_AssaultRifle.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Amit_Gomasta_StylizedAxe.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Subhajit_Samanta_Bengal_Village_Lowpoly.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work//Somtirtha_Saha_Spookynight.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Shivnath_Dutta_Storeroom_Interior.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Sayak_Khasnobis_CartoonGirl.jpg" alt="">
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <img class="img-fluid" src="./assets/img/student-work/Debabrata_Das_Reading_Room_Max.jpg" alt="">
                   </div>
                </div>
              </div>
              <div class="student-work__videos">
                <p>Student Work</p>
                <h1 class="student-work_photos_title">Videos</h1>
                <div class="row gy-3 gx-3">
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame"  src="https://www.youtube-nocookie.com/embed/Os2Tvc3b-Bk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/TdbfQDxF6WE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/46aq3AjQiro" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/UAlqZbuDy1Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/YAuY_0DHq4E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/2QgLgtaRXdY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/kaxHhqmfzqE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/7_4kJatruYo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/sstSHdFj9SU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/AWqAC28L5WA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/av1PzgkrHw8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/V2RKXIwWi-s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/MN-JbawVOSs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <iframe class="youtube-frame" src="https://www.youtube-nocookie.com/embed/co8OWozvEes" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   </div>
                </div>
              </div>
